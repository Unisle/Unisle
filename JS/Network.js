...
class Network {
    ...
    createProject(title, content_message, recruit_message, period, density_message) {
        //title, content_message, recruit_message, period, density_message are String
